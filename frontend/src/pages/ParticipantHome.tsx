          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-purple-200">Empowering your employment goals with AI tools & active support</p>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-white/10 hover:bg-white/20 text-white font-bold text-xs rounded-xl border border-white/20 backdrop-blur-sm transition-all shadow-sm"
              >
                <Search className="w-4 h-4 text-emerald-400" /> + Log Job Search Effort
              </button>
              <button
                onClick={() => setShowInterviewModal(true)}
                className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-purple-600/60 hover:bg-purple-600 text-white font-bold text-xs rounded-xl border border-purple-400/30 transition-all shadow-sm"
              >
                <Award className="w-4 h-4 text-purple-200" /> Got an Interview! 💼
              </button>
              <button
                onClick={() => setShowJobModal(true)}
                className="inline-flex items-center gap-1.5 px-3.5 py-2 bg-[#16a34a] hover:bg-emerald-600 text-white font-bold text-xs rounded-xl shadow-sm transition-all"
              >
                <Briefcase className="w-4 h-4" /> Got a Job! 🎉
              </button>
            </div>
          </div>
        </div>
